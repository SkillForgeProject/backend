...
public class AdministradorDAO {
    ...
    public UsuarioDto guardarUsuario(UsuarioDto usuario) {
        ...
        // Cargar departamento existente desde la BD
        Departamento dep = departamentoRepositorio.findById(usuario.getDepartamento().getId())
                .orElseThrow(() -> new RuntimeException("Departamento no encontrado"));
        usuarioEntidad.setDepartamento(dep);
